...
public final class CommandConstants {
  ...
  public static final String C3PO_CMD_VERSION = "0.0.1";
  ...
  public static final String EXPORT_OUTPUT_FILE = "output file";
  ...
  public static final String EXPORT_DESCRIPTION = "The file to write to";
