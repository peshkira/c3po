...
public class PreparedQueries {
	...
	public List<Property> getAllProperties() {
		return this
				.getEntityManager()
				.createNamedQuery(Constants.ALL_PROPERTIES_QUERY,
	...
	public List<Property> getAllPropertiesInCollection(
			DigitalCollection collection) {
		return this
				.getEntityManager()
				.createNamedQuery(Constants.ALL_COLLECTION_PROPERTIES_QUERY,
						Property.class).setParameter("coll", collection)
				.getResultList();
	}
	...
	public List<Value> getValuesByPropertyName(String pname,
		...
		return this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_VALUES_BY_PROPERTY_NAME_QUERY,
	...
	public List<Value> getValueByPropertyNameAndValue(String pname,
		...
		return this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_VALUES_BY_NAME_AND_VALUE,
						Value.class).setParameter("pname", pname)
				.setParameter("value", value).setParameter("coll", collection)
				.getResultList();
	}

	public long getElementsCount(DigitalCollection collection) {
		return (Long) this.getEntityManager()
				.createNamedQuery(Constants.COLLECTION_ELEMENTS_COUNT_QUERY)
	...
	public long getElementsWithPropertyCount(String pname,
		...
		return (Long) this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_ELEMENTS_WITH_PROPERTY_COUNT_QUERY)
				.setParameter("pname", pname).setParameter("coll", collection)
				.getSingleResult();
	}

	public long getElementsWithPropertyAndValueCount(String pname,
			String value, DigitalCollection coll) {
		return (Long) this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_ELEMENTS_WITH_PROPERTY_AND_VALUE_COUNT_QUERY)
				.setParameter("pname", pname).setParameter("value", value)
				.setParameter("coll", coll).getSingleResult();
	}

	public List<Element> getElementsWithPropertyAndValue(String pname,
			String value, DigitalCollection coll) {
		return this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_ELEMENTS_WITH_PROPERTY_AND_VALUE_SET_QUERY,
						Element.class).setParameter("pname", pname)
				.setParameter("value", value).setParameter("coll", coll)
				.getResultList();
	}
	...
	public long getDistinctPropertyValueCount(String pname,
		...
		return (Long) this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_DISTINCT_PROPERTY_VALUE_COUNT_QUERY)
				.setParameter("pname", pname).setParameter("coll", collection)
				.getSingleResult();
	}
	...
	public long getValuesForElementCount(Element e) {
		return (Long) this.getEntityManager()
				.createNamedQuery(Constants.VALUES_FOR_ELEMENT_COUNT)
	...
	public List<Object[]> getMostOccurringProperties(int limit,
		...
		return this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_MOST_OCCURRING_PROPERTIES)
				.setParameter("coll", collection).setMaxResults(limit)
				.getResultList();
	}
	...
	public long getSumOfNumericProperty(String pname,
			DigitalCollection collection) {
		return (Long) this.getEntityManager()
				.createNamedQuery(Constants.COLLECTION_SUM_VALUES_FOR_PROPERTY)
				.setParameter("pname", pname).setParameter("coll", collection)
				.getSingleResult();
	}
	...
	public double getAverageOfNumericProperty(String pname,
		...
		return (Double) this.getEntityManager()
				.createNamedQuery(Constants.COLLECTION_AVG_VALUES_FOR_PROPERTY)
				.setParameter("pname", pname).setParameter("coll", collection)
				.getSingleResult();
	}
	...
	public List<Object[]> getSpecificPropertyValuesDistribution(String pname,
		...
		return this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_SPECIFIC_VALUE_DISTRIBUTION)
				.setParameter("pname", pname).setParameter("coll", collection)
				.getResultList();
	}

	public List<String> getDistinctValuesWithinFiltering(String pname1,
			String pname2, String value, DigitalCollection coll) {
		return this
				.getEntityManager()
				.createNamedQuery(
	...
	public List<Element> getElementsWithinDoubleFilteredCollection(
			String pname1, String value1, String pname2, String value2,
			DigitalCollection coll) {
		return this
				.getEntityManager()
				.createNamedQuery(
						Constants.COLLECTION_ELEMENTS_WITHIN_DOUBLE_FILTER_SET_QUERY,
						Element.class).setParameter("pname1", pname1)
				.setParameter("value1", value1).setParameter("pname2", pname2)
				.setParameter("value2", value2).setParameter("coll", coll)
				.getResultList();
	}
