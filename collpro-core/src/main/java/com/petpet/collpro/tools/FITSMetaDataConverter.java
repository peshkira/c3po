...
public class FITSMetaDataConverter implements ITool {
  ...
  public void configure(Map<String, Object> configuration) throws ConfigurationException {
    ...
    if (c == null) {
      throw new ConfigurationException("No collection provided, please set a collection for field 'config.collection'");
    } else {
    ...
    if (f == null) {
      throw new ConfigurationException("No file array provided, please set a file array for field 'config.fits_files'");
    } else {
      this.files = (File[]) f;
    }
