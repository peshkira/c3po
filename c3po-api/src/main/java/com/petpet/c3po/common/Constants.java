...
public final class Constants {
   ...
   */
  /**
   * The name of the named query that retrieves all properties in a collection.
   */
   ...
   */
  /**
   * The name of the named query that retrieves all values of a property with a
   * certain name. Requires two parameters :pname and :coll for the property
   ...
   */
  /**
   * The name of the named query that counts the values for a specific element.
   * Requires one parameter ':element' for the element object.
   */
   ...
   */
  /**
   * The name of the named query that sums the values of the numeric properties
   * with the given name. Requires two parameters <i>:pname</i> and <i>:coll</i>
   * for the property name and the collection respectively.
   */
   ...
   * Object[] arrays that have length of three. The first Object is the property
   * name, the second - the value and the third the occurrences of this specific
   * value. Requires two parameters <i>:pname</i> and <i>:coll</i> for the
   * property name and the collection.
   */
