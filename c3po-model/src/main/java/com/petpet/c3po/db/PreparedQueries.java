...
public class PreparedQueries {
    ...
    public List<String> getAllPropertyNames() {
        return this.getEntityManager().createNamedQuery(Constants.ALL_PROPERTY_NAMES_QUERY, String.class)
                .getResultList();
    }
    ...
    public List<String> getDistinctValuesWithinFiltering(String pname1, String pname2, String value,
        ...
        return this.getEntityManager()
                .createNamedQuery("getDistinctValuesWithinPropertyFilteredCollection", String.class)
    ...
    public List<DigitalCollection> getAllCollections() {
        return this.getEntityManager().createNamedQuery(Constants.ALL_COLLECTIONS, DigitalCollection.class)
                .getResultList();
    }
