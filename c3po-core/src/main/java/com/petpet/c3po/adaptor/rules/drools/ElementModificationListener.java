...
/**
 * <p>
 * This listener is called whenever a new Object is inserted, modified or
 * deleted in the working memory. Insertion is done implicitly when calling
 * {@link StatelessKnowledgeSession#execute(Object)}, while the other events
 * need to be generated by the RHS of the drools rules, either by calling
 * retract() or using a modify{} block.
 * </p>
 * <p>
 * It basically keeps a copy of the elements {@link DBObject} representation as
 * long as it is in the working memory. Whenever a the element got changed, the
 * new {@link DBObject} representation is compared to the old one and all
 * changes are logged by creating a {@link LogEntry} and adding it to the
 * element.
 * </p>
 */
